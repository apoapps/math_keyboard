import 'package:apoapps_math_keyboard/src/custom_key_icons/custom_key_icons.dart';
...
import 'package:apoapps_math_keyboard/src/widgets/keyboard_button.dart';
import 'package:apoapps_math_keyboard/src/widgets/math_field.dart';
...
class MathKeyboard extends StatelessWidget {
  ...
  ///CUSTOM COLORS ON MATH KEYBOARD
                              ...
                              Padding(
                                ...
                                child: _Buttons(
                                  ...
                                  page2: type == MathKeyboardType.numberOnly
                                      ...
                                      : functionKeyboard,
                                  onSubmit: onSubmit,
                                  keyboardAccentColor: keyboardAccentColor,
                                  textColor: textColor,
                                ),
                              ),
                            ],
  ...
  Widget build(BuildContext context) {
    return Expanded(
      ...
      child: KeyboardButton(
        onTap: onTap,
        onHold: onTap,
        color: keyboardAccentColor, //todo: make this a customizable color
        child: Icon(
          icon,
          color: textColor, //todo: make this a customizable color
          size: iconSize,
        ),
      ),
    );
